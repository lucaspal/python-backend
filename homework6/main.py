...
class Main:
    ...
    def parse_details(self, details_string: str):
    ...
    def init(self):
        battleship_one = self.battleship_from_cli(1)
        battleship_two = self.battleship_from_cli(2)
        print('\n')

        return Opponents([battleship_one, battleship_two])

    def battleship_from_cli(self, battleship_number: int):
        ...
        parsed_details = self.parse_details(battleship_details)
